create column table "CART_REQUEST_TOOL".hl2 (
	...
	FOREIGN KEY (budget_year_id) REFERENCES "CART_REQUEST_TOOL".budget_year(budget_year_id),
	FOREIGN KEY (team_type_id) REFERENCES "CART_REQUEST_TOOL".team_type(team_type_id)
);