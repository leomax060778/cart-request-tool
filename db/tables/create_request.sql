CREATE COLUMN TABLE "CART_REQUEST_TOOL".REQUEST(
	...
	MASKED_ALTERNATIVE_VENDOR TINYINT DEFAULT 0,
...
;
ALTER TABLE "CART_REQUEST_TOOL"."REQUEST" ADD FOREIGN KEY ( "VENDOR_ADDITIONAL_INFORMATION_ID" ) REFERENCES "CART_REQUEST_TOOL"."VENDOR_ADDITIONAL_INFORMATION" ("VENDOR_ADDITIONAL_INFORMATION_ID") ON UPDATE RESTRICT ON DELETE RESTRICT
;
...
;
ALTER TABLE "CART_REQUEST_TOOL"."REQUEST" ADD FOREIGN KEY ( "BUDGET_YEAR_ID" ) REFERENCES "CART_REQUEST_TOOL"."BUDGET_YEAR" ("BUDGET_YEAR_ID") ON UPDATE RESTRICT ON DELETE RESTRICT
;