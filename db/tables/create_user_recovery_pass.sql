CREATE COLUMN TABLE "CART_REQUEST_TOOL"."USER_RECOVERY_TOKEN"
(
...
ALTER TABLE "CART_REQUEST_TOOL"."USER_RECOVERY_TOKEN" ADD FOREIGN KEY ( "USER_ID" ) REFERENCES "CART_REQUEST_TOOL"."USER" ("USER_ID") ON UPDATE RESTRICT ON DELETE RESTRICT
;
