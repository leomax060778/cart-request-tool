...
RENAME COLUMN "CART_REQUEST_TOOL"."INQUIRY_MESSAGE".ISSUE_TYPE_ID to SUBJECT_ID;
RENAME COLUMN "CART_REQUEST_TOOL"."INQUIRY_MESSAGE".ADDITIONAL_RETURN_TYPE_INFORMATION to ADDITIONAL_MESSAGE_TYPE_INFORMATION;
RENAME COLUMN "CART_REQUEST_TOOL"."INQUIRY_MESSAGE".ADDITIONAL_ISSUE_TYPE_INFORMATION to ADDITIONAL_SUBJECT_INFORMATION;
	-- REQUEST_MESSAGE
