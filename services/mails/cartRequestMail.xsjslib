...
function parseReturnToRequest(cartRequestObj, basicData,  userName){
	...
	'to access this specific request: <a href="'+basicData.URL_BASE+basicData.PATH+'/'+cartRequestObj.REQUEST_ID+'">Cart Request Manager</a><br /> <br />';
	mailObj.subject = basicData.ENVIRONMENT+' CRT Request ID: CR'+cartRequestObj.REQUEST_ID+' - Action/Response Required Message - '+getDateNow()+'';
	return mailObj;
}
...
function parseCancelled(cartRequestObj,basicData,  userName){
	...
	mailObj.subject = basicData.ENVIRONMENT+'CRT Request ID: CR'+cartRequestObj.REQUEST_ID+' - Cart Request - has been Cancelled - '+getDateNow()+'';
	return mailObj;
}
...
function parseResubmitted(cartRequestObj, basicData,  userName){
	...
	'<a href="'+basicData.URL_BASE+basicData.PATH+'/'+cartRequestObj.REQUEST_ID+'">Cart Request Manager</a><br/><br />';
	mailObj.subject = basicData.ENVIRONMENT+'CRT Request ID: CR'+cartRequestObj.REQUEST_ID+' - Cart Request Re-Submitted - '+getDateNow()+'';
	return mailObj;
}
...
function parseApproved(cartRequestObj, basicData,  userName){
	...
	'<a href="'+basicData.URL_BASE+basicData.PATH+'/'+cartRequestObj.REQUEST_ID+'">Cart Request Manager</a><br/><br />';
	mailObj.subject = basicData.ENVIRONMENT+'CRT Request ID: CR'+cartRequestObj.REQUEST_ID+' - Cart Request Approved - '+getDateNow()+'';
	return mailObj;
}
...
function parseInProcess(cartRequestObj, basicData,  userName){
	...
	'<a href="'+basicData.URL_BASE+basicData.PATH+'/'+cartRequestObj.REQUEST_ID+'">Cart Request Manager</a><br/><br />';
	mailObj.subject = basicData.ENVIRONMENT+'CRT Request ID: CR'+cartRequestObj.REQUEST_ID+' - Cart Request is In Process - '+getDateNow()+'';
	return mailObj;
}
...
function parseFYI(cartRequestObj, basicData,  userName){
	...
	'specific request: <a href="'+basicData.URL_BASE+basicData.PATH+'/'+cartRequestObj.REQUEST_ID+'">Cart Request Manager</a><br/><br />';
	mailObj.subject = basicData.ENVIRONMENT+'CRT Request ID: CR'+cartRequestObj.REQUEST_ID+' - FYI Only Messagge - '+getDateNow()+'';
	return mailObj;
}
