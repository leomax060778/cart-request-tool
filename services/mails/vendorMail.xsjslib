...
function parseSubmit(vendorObj,path, userName){
	var mailObj = {};
...
function parseCancelled(vendorObj,path, userName){
	var mailObj = {};
	mailObj.body =  'Dear '
	+ userName +
	',<br /><br />Your <b>NV'
...
function parseResubmitted(vendorObj, path , userName){
	var mailObj = {};
...
function parseFYI(vendorObj, path, userName){
	var mailObj = {};
...
function parseReturnToRequest(vendorObj, path, userName){
	var mailObj = {};
