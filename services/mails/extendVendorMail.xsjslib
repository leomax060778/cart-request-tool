...
function parseReturnToRequest(extendVendorObj, urlBase, path, userName){
	var mailObj = {};
...
function parseCancelled(extendVendorObj,urlBase, path, userName){
	var mailObj = {};
...
function parseSubmit(extendVendorObj,urlBase, path, userName){
	var mailObj = {};
...
function parseResubmitted(extendVendorObj, urlBase, path, userName){
	var mailObj = {};
	mailObj.body = '<b>Dear CRT Admin,</b><br /><br /> You have new activity within the '+
...
function parseApproved(extendVendorObj, urlBase, path, userName){
	var mailObj = {};
...
function parseInProcess(extendVendorObj, urlBase, path, userName){
	var mailObj = {};
...
function parseFYI(extendVendorObj, urlBase, path, userName){
	var mailObj = {};
