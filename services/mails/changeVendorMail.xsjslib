...
function parseReturnToRequest(changeVendorObj, urlBase, path,  userName){
	var mailObj = {};
...
function parseCanceled(changeVendorObj,urlBase, path,  userName){
	var mailObj = {};
...
function parseSubmit(changeVendorObj,urlBase, path,  userName){
	var mailObj = {};
...
function parseResubmitted(changeVendorObj, urlBase , path, userName){
	var mailObj = {};
	mailObj.body =  '<b>Dear CRT Admin,</b> <br /> <br /> You have new activity within the '+
...
function parseApproved(changeVendorObj, urlBase, path,  userName){
	var mailObj = {};
...
function parseFYI(changeVendorObj, urlBase, path,  userName){
	var mailObj = {};
...
function parseInProcess(changeVendorObj, urlBase, path,  userName){
	var mailObj = {};
