...
function parseReturnToRequest(inquiryObj,path, userName){
	var mailObj = {};
	...
	'Request Tool.</b><br /><br />Log in to CRT using Google Chrome, then copy and paste the following '+
	'link if you would like to access this specific request: '+
	'<a href="'+path+'/crtInquiry">INQUIRY</a><br /><br />';
	mailObj.subject = 'CRT Request ID: CI'+inquiryObj.INQUIRY_ID+' - Action/Response Required Message - '+getDateNow()+'';
	return mailObj;
}

function parseSubmit(inquiryObj,path, userName){
	var mailObj = {};
	mailObj.body =  '<b>Dear CRT '+userName+',</b><br /><br /> You have new activity within the <b>Cart Request Tool.</b>'+
	'<br /><br /> <b>Requester '+userName+' has created a CI'+inquiryObj.INQUIRY_ID+'</b><br /><br /> Log in to CRT using '+
	'Google Chrome, then copy and paste the following link if you would like to access this specific request: '+
	'<a href="'+path+'/crtInquiry">INQUIRY</a><br /><br />';
	mailObj.subject = 'CRT Request ID: CI'+inquiryObj.INQUIRY_ID+' - CRT Inquiry Created - '+getDateNow()+'';
	return mailObj;
}

function parseCancelled(inquiryObj, path, userName){'+'
	var mailObj = {};
	...
	'<br /><br />Log in to CRT using Google Chrome, then copy and paste the following link if you would '+
...
function parseResubmitted(inquiryObj, path , userName){
	var mailObj = {};
...
function parseCompleted(inquiryObj, path, userName){
	var mailObj = {};
	mailObj.body =  'Dear '+userName+'<br /><br />Your <b>CI'+inquiryObj.INQUIRY_ID+'</b> has been <b>Completed.</b><br /><br />'+
	'You may review the response in the Message History of your inquiry.<br /><br />Log in to CRT using '+
	'Google Chrome, then copy and paste the following link if you would like to access this specific request: '+
	'<a href="'+path+'/crtInquiry">INQUIRY</a><br /><br />';
...
function parseFYI(inquiryObj, path, userName){
	var mailObj = {};
	...
	'The message is <b>FYI Only, requiring no response.</b><br /><br />Log in to CRT using '+
	'Google Chrome, then copy and paste the following link if you would like to access this '+
	'specific request: '+
	'<a href="'+path+'/crtInquiry">INQUIRY</a><br /><br />';
