...
function parseReturnToRequest(vendorInquiryObj, path, userName){
	var mailObj = {};
...
function parseCompleted(vendorInquiryObj,path, userName){
	var mailObj = {};
...
function parseCancelled(vendorInquiryObj,path, userName){
	var mailObj = {};
...
function parseSubmit(vendorInquiryObj,path, userName){
	var mailObj = {};
...
function parseResubmitted(vendorInquiryObj, path , userName){
	var mailObj = {};
	mailObj.body =  '<b>Dear CRT Admin,</b><br /><br /> You have new activity within '+
...
function parseFYI(vendorInquiryObj, path, userName){
	var mailObj = {};
