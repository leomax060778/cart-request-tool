...
function sendMail(reqBody, defaultBody, OptionalSender) {
	try {
		...
		if (validate(reqBody)) {
			...
			var rdo = "MessageId = " + returnValue.messageId + ", final reply="
