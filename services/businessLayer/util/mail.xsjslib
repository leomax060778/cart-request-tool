...
function sendMailServlet(reqBody, defaultBody){
	...
	jsonObject.addressTo = reqBody.TO;
	jsonObject.subject = reqBody.SUBJECT;
	jsonObject.message = reqBody.BODY; */
	
	/*	  var client = new $.net.http.Client();
		  var dest = $.net.http.readDestination("xscartrequesttool.services.businessLayer.util", "EmailSendingWebApp");
		  var request = new $.net.http.Request($.net.http.POST, "/");
		  
		  // Header parameters
		  request.headers.set("dataType", "json");
	...
	/* jQuery.ajax({
	        ...
	        data: JSON.stringify({"addressTo": "iberon@folderit.net",
	                "addressBcc": "beronisaac@gmail.com",
