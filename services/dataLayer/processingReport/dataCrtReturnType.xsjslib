...
function deleteCrtReturnType(objCrtReturnType, userId) {
    var parameters = {};
    parameters.in_crt_type_id = objCrtReturnType.IN_CRT_TYPE_ID;
    parameters.in_return_type_id = objCrtReturnType.IN_RETURN_TYPE_ID;
    parameters.in_modified_user_id = userId;//objCrtReturnType.IN_MODIFIED_USER_ID;
...
function insertCrtReturnType(objCrtReturnType, userId) {
    ...
    parameters.in_crt_type_id = objCrtReturnType.IN_CRT_TYPE_ID;
    parameters.in_return_type_id = objCrtReturnType.IN_RETURN_TYPE_ID;
    parameters.in_created_user_id = userId;//objCrtReturnType.IN_CREATED_USER_ID;
    parameters.out_result = '?';
