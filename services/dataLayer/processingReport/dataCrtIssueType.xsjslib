...
function deleteCrtIssueType(objCrtIssueType, userId) {
    var parameters = {};
    parameters.in_crt_type_id = objCrtIssueType.IN_CRT_TYPE_ID;
    parameters.in_issue_type_id = objCrtIssueType.IN_ISSUE_TYPE_ID;
    parameters.in_modified_user_id = userId;//objCrtIssueType.IN_MODIFIED_USER_ID;
...
function insertCrtIssueType(objCrtIssueType, userId) {
    ...
    parameters.in_crt_type_id = objCrtIssueType.IN_CRT_TYPE_ID;
    parameters.in_issue_type_id = objCrtIssueType.IN_ISSUE_TYPE_ID;
    parameters.in_created_user_id = userId;//objCrtIssueType.IN_CREATED_USER_ID;
    parameters.out_result = '?';
